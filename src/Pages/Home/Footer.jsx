  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div className="nav_font">Devanshu</div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/devanshu.dudhiya/"
            ...
            <li>
              <a
                href="https://www.instagram.com/devanshu_dd/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/devanshudd/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Devanshu</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
